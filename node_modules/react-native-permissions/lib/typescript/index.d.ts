...
export declare function check(permission: Permission): Promise<PermissionStatus>;
export declare function request(permission: Permission, rationale?: Rationale): Promise<PermissionStatus>;
